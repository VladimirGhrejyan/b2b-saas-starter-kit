...
export const codedErrorHttpStatuses: Readonly<Record<string, number>> = {
  ...
  API_KEY_CANNOT_MANAGE_KEYS: HttpStatus.BAD_REQUEST,
  API_KEY_INVALID_NAME: HttpStatus.BAD_REQUEST,
  API_KEY_EMPTY_PERMISSIONS: HttpStatus.BAD_REQUEST,
  ...
  IDEMPOTENCY_SCOPE_UNAVAILABLE: HttpStatus.BAD_REQUEST,
